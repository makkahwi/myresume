import { FaBootstrap, FaBroadcastTower, FaCamera, FaChartBar, FaCloud, FaCoffee, FaCss3Alt, FaDatabase, FaDiscord, FaDocker, FaEdit, FaEnvelope, FaFacebook, FaFan, FaFigma, FaFileAlt, FaGithub, FaGlobe, FaHackerrank, FaHashtag, FaHtml5, FaImages, FaInstagram, FaJs, FaKaggle, FaLaravel, FaLinkedin, FaMicrosoft, FaNewspaper, FaNode, FaNodeJs, FaPaintBrush, FaPaintRoller, FaPhoneVolume, FaPhp, FaPython, FaReact, FaRing, FaScroll, FaShapes, FaSlack, FaSyncAlt, FaTelegram, FaVectorSquare, FaVideo, FaVuejs, FaWhatsapp, FaWordpress } from "react-icons/fa";
  ...
  about: {
    web: {
      ...
      downloads: [
        {
          text: "Resume Sheet",
          link: "/Suhaib-Ahmad-WD-Resume-Sheet.pdf",
          Icon: FaFileAlt,
        },
        {
          text: "Personality Test",
          link: "https://www.16personalities.com/profiles/aa175983b37f8",
          Icon: FaScroll,
        },
        {
          text: "Psychometric Analysis",
          link: "/Suhaib-Ahmad-Psychometric.pdf",
          Icon: FaChartBar,
        },
      ],
    ...
    gd: {
      ...
      downloads: [
        {
          text: "Resume Sheet",
          link: "/Suhaib-Ahmad-GD-Resume-Sheet.pdf",
          Icon: FaFileAlt,
        },
        {
          text: "Personality Test",
      ...
      jobsList: [
        {
          ...
          description:
            "Full-time job to develop React.Js web apps for online public (government) services.",
          title: "Delivery Consultant (Senior React Developer)",
          // certificate: "/deloitte.pdf",
      ...
      jobsList: [
        {
          ...
          description:
            "Part-time temporary work about designing and preparing for a social-media promotional campaign.",
        ...
        },
        {
          ...
          description:
            "Part-time work included gaphic designing & events management.",
          title: "PR Executive",
          certificate: "",
        ...
        },
        {
          ...
          description:
            "Univeristy club volunteering work to prepare the publicity materials of digital and print-out designs.",
          title: "Media Bureau",
          certificate: "",
