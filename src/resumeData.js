   ...
   resume: {
      web: {
         jobsList: [
            {
               ...
               description: "Full-time job to develop React.Js-Node.Js web apps for online public (government) services.",
         ...
         skillsList: [
            ...
            { icon: faWordpress, name: "Wordpress", color: "21759b", website: "https://wordpress.com/", subskills: ["Elementor", "Contact Form 7"] },
