    ...
    <section id="about">
      <div className="row">
        ...
        <div className="six columns main-col">
          <h5 className={`bio ${i18n.language === "ar" && "arabic padding"}`}>
            {t(bio)}{" "}
            {t(
              "You may scroll down to see it for yourself, and you may also download my..."
            )}
          </h5>
          <div className="row">
            {downloads.map((file, i) => (
              <div
                className={`${filesLength(downloads.length)} columns`}
                key={i}
              >
                <a
                  target="_blank"
